  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved draft as @draft" do
        post :create, {:draft => invalid_attributes}, valid_session
        expect(assigns(:draft)).to be_a_new(Draft)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested draft" do
        draft = Draft.create! valid_attributes
        put :update, {:id => draft.to_param, :draft => new_attributes}, valid_session
        draft.reload
    ...
    context "with invalid params" do
      it "assigns the draft as @draft" do
        draft = Draft.create! valid_attributes
        put :update, {:id => draft.to_param, :draft => invalid_attributes}, valid_session
        expect(assigns(:draft)).to eq(draft)
      end
